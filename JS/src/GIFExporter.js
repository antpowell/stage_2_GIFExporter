    ...
    GIFExporter.prototype.getSnapShotDataFromCanvas = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this._intervalRef = setInterval(function () {
                ...
                var pixels = new Uint8Array(((gl.drawingBufferWidth / 2) | 0) *
                    ((gl.drawingBufferHeight / 2) | 0) *
                    4);
                gl.readPixels(0, 0, (gl.drawingBufferWidth / 2) | 0, (gl.drawingBufferHeight / 2) | 0, gl.RGBA, gl.UNSIGNED_BYTE, pixels);
