...
var gifGenerator = new gif_generator_1.GIFGenerator();
    ...
    switch (data.job) {
        case 'init':
            var _b = data.params,
                width = _b.width,
                height = _b.height,
                globalColorTable = _b.globalColorTable;
            init(width, height, globalColorTable);
            break;
        case 'generateFrame':
            var frames = data.params.frames;
            addFrames(frames);
            break;
        case 'getStream':
            getStream();
...
},{"./gif.generator":15}],37:[function(require,module,exports) {
