...
function init(_a) {
    var weight = _a.weight,
        height = _a.height,
        GCT = _a.GCT;
    var gifGenerator = new gif_generator_1.GIFGenerator(weight, height, GCT);
    gifGenerator.init();
    postMessage('init complete', 'self');
}
function addFrames(_a) {
    var _this = this;
    var frames = _a.frames,
        gifInstance = _a.gifInstance;
    frames.forEach(function (frame) {
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, gifInstance.generateFrame(frame)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
},{"./gif.generator":15}],40:[function(require,module,exports) {
